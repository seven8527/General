...
+ (NSString *)getVideoSaveFilePathString
{
    ...
    if ([self createVideoFolderIfNotExist]) {
...
- (void)startVideoCapture
{
    ...
    [self _enqueueBlockInCaptureVideoQueue:^{
        ...
        NSString *outputPath = [PBJVision getVideoSaveFilePathString];
...
//											  nil];
    ...
    NSDictionary *videoCompressionSettings = [NSDictionary dictionaryWithObjectsAndKeys:
                                              ...
                                              AVVideoScalingModeResizeAspectFill, AVVideoScalingModeKey,
                                              [NSNumber numberWithInteger:dimensions.width], AVVideoWidthKey,
                                              [NSNumber numberWithInteger:dimensions.width * 3/4], AVVideoHeightKey, // square format
                                              compressionSettings, AVVideoCompressionPropertiesKey,
                                              nil];
