...
@property (nonatomic, strong) UIImageView *bannerBottomView;
...
- (id)initWithFrame:(CGRect)frame animationDuration:(NSTimeInterval)animationDuration
{
    ...
    if (animationDuration > 0.0) {
        ...
        pageControl.currentPageIndicatorTintColor = [UIColor colorFromHexRGB:k00947DColor];;
        ...
        UIImageView *bannerImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.frame.size.height - 34, kScreen_Width, 34)];
        bannerImageView.image = [[UIImage imageNamed:@"home_banner_shade_"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0) resizingMode:UIImageResizingModeTile];
