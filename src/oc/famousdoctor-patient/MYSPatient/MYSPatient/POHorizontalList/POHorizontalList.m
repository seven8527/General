...
//        self.scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0.0f, 12.0f, self.frame.size.width, self.frame.size.height)];
//
...
//                                   (id)[[UIColor colorWithHex:0xfafafa] CGColor],
//                                   (id)[[UIColor colorWithHex:0xfafafa] CGColor], nil];
//         
...
- (void)setItems:(NSArray *)items
{
    ...
    dropshadowLayer.locations = [NSArray arrayWithObjects:
                                 ...
                                 [NSNumber numberWithFloat:1.0f], nil];
    dropshadowLayer.colors = [NSArray arrayWithObjects:
                              (id)[[UIColor colorFromHexRGB:@"fafafa"] CGColor],
                              (id)[[UIColor colorFromHexRGB:@"fafafa"] CGColor], nil];
