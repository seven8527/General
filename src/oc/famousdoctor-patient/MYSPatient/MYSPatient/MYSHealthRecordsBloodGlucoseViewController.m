//
//  MYSHealthRecordsBloodGlucoseViewController.m
//  MYSPatient
//
...
@interface MYSHealthRecordsBloodGlucoseViewController ()
@property (nonatomic, weak) UISegmentedControl *segment;
@property (nonatomic, strong) MYSHealthRecordsBloodGlucoseRecordViewController *recordVC;
@property (nonatomic, strong)  MYSHealthRecordsBloodGlucoseChartViewController *chartVC;
@end

@implementation MYSHealthRecordsBloodGlucoseViewController
...
- (void)viewDidLoad {
    ...
    MYSHealthRecordsBloodGlucoseChartViewController *chartVC  = [[MYSHealthRecordsBloodGlucoseChartViewController alloc] init];
    ...
    MYSHealthRecordsBloodGlucoseRecordViewController *recordVC = [[MYSHealthRecordsBloodGlucoseRecordViewController alloc] init];
...
{
    UIViewController <MYSHealthRecordsBloodGlucoseListViewControllerProtocol> *viewController = [[JSObjection defaultInjector] getObject:@protocol(MYSHealthRecordsBloodGlucoseListViewControllerProtocol)];
