...
-(void)addScroll1{
    ...
    CGSize size0 =[self.xl_buttonNames[self.selectedIndex] sizeWithAttributes:@{NSFontAttributeName :[UIFont systemFontOfSize:self.xl_buttonFont?self.xl_buttonFont:18]}];
    UIButton *button0 =self.buttons[self.selectedIndex];
...
//    self.view2 =[[UIView alloc]initWithFrame:CGRectMake(_x0,CGRectGetMaxY(button0.frame)-(self.xl_buttonToSlider?self.xl_buttonToSlider:10), size0.width, self.xl_sliderHeight?self.xl_sliderHeight:2)];
     ...
     self.view2 =[[UIView alloc]initWithFrame:CGRectMake(_x0 -(self.xl_bottomLineWidth - size0.width)/2,CGRectGetMaxY(button0.frame) - 2, self.xl_bottomLineWidth, self.xl_sliderHeight?self.xl_sliderHeight:2)];
...
-(void)addScroll2{
    ...
    self.scroll2.contentOffset=CGPointMake(kScreen_Width * self.selectedIndex, 0);
...
//            rect.size.width =size.width;
            rect.size.width =self.xl_bottomLineWidth;
...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if ([self.delegate respondsToSelector:@selector(scrollViewerScrolledToPage:)]) {
        [self.delegate scrollViewerScrolledToPage:scrollView.contentOffset.x/kScreen_Width];
    }
