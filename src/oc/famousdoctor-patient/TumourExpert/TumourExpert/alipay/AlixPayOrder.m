...
- (NSString *)description {
	...
	[discription appendFormat:@"&return_url=\"%@\"", self.returnUrl ? self.returnUrl : @"http://www.mingyisheng.com/"];
	[discription appendFormat:@"&it_b_pay=\"%@\"", self.itBPay ? self.itBPay : @"1d"];
	[discription appendFormat:@"&show_url=\"%@\"", self.showUrl ? self.showUrl : @"http://www.mingyisheng.com/"];
