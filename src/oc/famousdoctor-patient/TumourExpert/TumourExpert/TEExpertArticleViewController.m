//
//  TEExpertArticleViewController.m
//  TumourExpert
//
...
@interface TEExpertArticleViewController ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) DTAttributedTextView *attributedTextView;
@property (nonatomic, strong) TEExpertArticle *expertArticle;
@end

@implementation TEExpertArticleViewController
...
// 获取专家专栏里的文章
- (void)fetchExpertArticle
{
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:self.view animated:YES];
    hud.mode = MBProgressHUDModeIndeterminate;
    hud.labelText = @"正在加载";
    
    NSString *URLString = [kURL_ROOT stringByAppendingString:@"article"];
    NSDictionary *parameters = @{@"dcaid": self.articleId};
    [TEHttpTools post:URLString params:parameters success:^(id responseObject) {
        NSLog(@"%@", responseObject);
        
        self.expertArticle = [[TEExpertArticle alloc] initWithDictionary:responseObject error:nil];
        self.titleLabel.text = self.expertArticle.article.title;
        ...
        NSString *str = [self.expertArticle.article.content stringByReplacingOccurrencesOfString:@"<p><br/></p>" withString:@""];
