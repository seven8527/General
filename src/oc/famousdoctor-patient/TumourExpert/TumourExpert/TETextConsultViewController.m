...
@interface TETextConsultViewController () <TEReusableTextViewViewControllerDelegate>
...
@implementation TETextConsultViewController
...
- (void)fetchAsk
{
    ...
    NSDictionary *parameters = @{@"doctorid": self.expertId, @"type": @"0"};
    [TEHttpTools post:URLString params:parameters success:^(id responseObject) {
        NSLog(@"%@", responseObject);
