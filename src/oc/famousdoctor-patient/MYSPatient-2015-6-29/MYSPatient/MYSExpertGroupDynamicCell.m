...
@interface MYSExpertGroupDynamicCell ()
...
@implementation MYSExpertGroupDynamicCell
...
- (void)setupViews
{
    ...
    contentImageView.userInteractionEnabled = NO;
...
- (void)setDynamicFrame:(MYSExpertGroupDynamicFrame *)dynamicFrame
{
    _dynamicFrame = dynamicFrame;
    
    MYSDoctorHomeDynamicModel *dynamicModel = dynamicFrame.dynamicModel;
    
    self.firstLine.frame = dynamicFrame.firstLineF;
    
    self.tipImageView.frame = dynamicFrame.tipImageViewF;
    NSString *title;
    ...
    self.contentImageView.frame = dynamicFrame.picImageF;
    [self.contentImageView sd_setImageWithURL:[NSURL URLWithString:dynamicModel.picurl]];
    
    self.titleLabel.text = title;
    self.titleLabel.frame = dynamicFrame.titleLabelF;
    
    
    self.timePicView.frame = dynamicFrame.timePicF;
    
    self.timeLabel.frame = dynamicFrame.timeLabelF;
    self.timeLabel.text = dynamicModel.addTime;
    
    self.secondLine.frame = dynamicFrame.secondLineF;
