//
//  MYSHealthRecordsWeightListViewController.m
//  MYSPatient
//
...
@interface MYSHealthRecordsWeightListViewController ()

@end

@implementation MYSHealthRecordsWeightListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    healthRecordsListCell.identification = 3;
