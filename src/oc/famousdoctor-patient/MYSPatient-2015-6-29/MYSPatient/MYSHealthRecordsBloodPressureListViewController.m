//
//  MYSHealthRecordsBloodPressureListViewController.m
//  MYSPatient
//
...
@interface MYSHealthRecordsBloodPressureListViewController () <UITableViewDataSource,UITableViewDelegate>

@end

@implementation MYSHealthRecordsBloodPressureListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    healthRecordsListCell.identification = 1;
