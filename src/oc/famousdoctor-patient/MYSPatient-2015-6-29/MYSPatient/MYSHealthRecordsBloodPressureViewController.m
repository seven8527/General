//
//  MYSHealthRecordsBloodPressureViewController.m
//  MYSPatient
//
...
#import "MYSHealthRecordsBloodPressureViewController.h"
#import "UIColor+Hex.h"
#import "MYSHealthRecordsBloodPressureRecordViewController.h"
#import "MYSHealthRecordsBloodPressureChartViewController.h"

@interface MYSHealthRecordsBloodPressureViewController ()
@property (nonatomic, strong) MYSHealthRecordsBloodPressureRecordViewController *recordVC;
@property (nonatomic, strong) MYSHealthRecordsBloodPressureChartViewController *chartVC;
@property (nonatomic, weak) UISegmentedControl *segment;
@end

@implementation MYSHealthRecordsBloodPressureViewController
...
- (void)viewDidLoad {
    ...
    MYSHealthRecordsBloodPressureChartViewController *chartVC  = [[MYSHealthRecordsBloodPressureChartViewController alloc] init];
    ...
    MYSHealthRecordsBloodPressureRecordViewController *recordVC = [[MYSHealthRecordsBloodPressureRecordViewController alloc] init];
...
{
    UIViewController <MYSHealthRecordsBloodPressureListViewControllerProtocol> *viewController = [[JSObjection defaultInjector] getObject:@protocol(MYSHealthRecordsBloodPressureListViewControllerProtocol)];
