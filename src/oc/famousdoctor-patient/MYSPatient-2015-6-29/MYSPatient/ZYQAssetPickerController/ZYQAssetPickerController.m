...
#define kPopoverContentSize CGSizeMake(kScreen_Width, kScreen_Height)
...
-(void)drawRect:(CGRect)rect{
    ...
    NSDictionary *titleDict = @{NSFontAttributeName :self.font};
    CGSize titleSize        = [self.text sizeWithAttributes:titleDict];
    [self.textColor set];
...
@property (nonatomic, weak) UILabel *totalOptionalNumberLabel;
...
- (id)init
{
    ...
    _mainTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, kScreen_Height -64 - 44) style:UITableViewStylePlain];
    ...
    {
        self.mainTableView.contentInset=UIEdgeInsetsMake(9.0, 2.0, 60, 2.0);
    ...
    {
        self.mainTableView.contentInset=UIEdgeInsetsMake(9.0, 0, 0, 0);
...
- (void)setupViews
{
    ...
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, kScreen_Height - 44 - 64, kScreen_Width, 44)];
    bottomView.backgroundColor = [UIColor colorFromHexRGB:KFFFFFFColor];
    ...
    UILabel *tipLabel = [[UILabel alloc] initWithFrame:CGRectMake(kScreen_Width - 130, 0, 10, 44)];
    tipLabel.textColor = [UIColor colorFromHexRGB:K00907FColor];
    tipLabel.font = [UIFont systemFontOfSize:16];
    tipLabel.text = @"0";
    self.tipLabel = tipLabel;
    [bottomView addSubview:tipLabel];
    
    UILabel *totalOptionalNumberLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(tipLabel.frame), 0, 15, 44)];
    totalOptionalNumberLabel.textColor = [UIColor colorFromHexRGB:K747474Color];
    totalOptionalNumberLabel.font = [UIFont systemFontOfSize:14];
    self.totalOptionalNumberLabel = totalOptionalNumberLabel;
    
    [bottomView addSubview:totalOptionalNumberLabel];
    
    
    UIButton *updataButton = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(totalOptionalNumberLabel.frame) + 14, 4.5, 86, 35)];
    updataButton.backgroundColor = [UIColor colorFromHexRGB:KFFFFFFColor];
    [updataButton.titleLabel setFont:[UIFont systemFontOfSize:14]];
    updataButton.layer.cornerRadius = 5;
    [updataButton.layer setBorderWidth:1];
    [updataButton.layer setBorderColor:[UIColor colorFromHexRGB:K00907FColor].CGColor];
    [updataButton setTitleColor:[UIColor colorFromHexRGB:K00907FColor] forState:UIControlStateNormal];
    [updataButton setTitle:@"上传" forState:UIControlStateNormal];
    [updataButton addTarget:self action:@selector(finishPickingAssets:) forControlEvents:UIControlEventTouchUpInside];
    [bottomView addSubview:updataButton];
...
- (void)setMaximumNumberOfSelection:(NSInteger)maximumNumberOfSelection
{
    ...
    LOG(@"%ld",(long)maximumNumberOfSelection);
   self.totalOptionalNumberLabel.text = [NSString stringWithFormat:@"/%ld",(long)_maximumNumberOfSelection];
}
...
- (void)setupAssets
{
    ...
    ALAssetsGroupEnumerationResultsBlock resultsBlock = ^(ALAsset *asset, NSUInteger index, BOOL *stop) {
        ...
        else if (self.assets.count > 0)
        {
            ...
            [self.mainTableView scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:ceil(self.assets.count*1.0/columns)  inSection:0] atScrollPosition:UITableViewScrollPositionTop animated:YES];
        }
    };
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell bind:tempAssets selectionFilter:picker.selectionFilter minimumInteritemSpacing:minimumInteritemSpacing minimumLineSpacing:minimumLineSpacing columns:columns assetViewX:(self.mainTableView.frame.size.width-kThumbnailSize.width*tempAssets.count-minimumInteritemSpacing*(tempAssets.count-1))/2];
    return cell;
}
...
//    self.title = [NSString stringWithFormat:format, (long)indexPaths.count];
    self.tipLabel.text = [NSString stringWithFormat:@"%ld",(long)indexPaths.count];
}
...
#pragma mark - ZYQAssetPickerController
@interface ZYQAssetPickerController ()
@property (nonatomic, strong) ZYQAssetGroupViewController *groupViewController;
@end
...
//    groupViewController.maximumNumberOfSelection = _maximumNumberOfSelection;
...
{
    _maximumNumberOfSelection = maximumNumberOfSelection;
    self.groupViewController.maximumNumberOfSelection = _maximumNumberOfSelection;
